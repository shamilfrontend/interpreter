  ...
  <div class="project-key">
    <div class="project-key__left">
      ...
      <div class="key-buttons">
        <el-tooltip content="Attach screenshot (JPG, PNG) 5mb" placement="top">
          <button
            class="key-buttons__btn key-buttons__btn_attach"
            @click="handleFileButtonClick(keyData.id)"
          />
        </el-tooltip>
        <el-tooltip content="Комментарии" placement="top">
          <button
            class="key-buttons__btn  key-buttons__btn_comments"
        ...
        <el-tooltip v-if="!isTranslator" content="Удалить ключ" placement="top">
          <button
            class="key-buttons__btn key-buttons__btn_thash"
...
.key-buttons {
  ...
  &__btn {
    ...
    &_attach {
      background-image: url('/icons/icon-attach.svg');
    }

    &_comments {
      background-image: url('/icons/icon-comments.svg');
    }

    &_thash {
      background-image: url('/icons/icon-trash-small.svg');
    }
  }
}
